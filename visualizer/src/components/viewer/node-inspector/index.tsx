...
export const TuringNodeInspector = () => {
  ...
  // On the studio graphs, node details are shown by the floating property card
  // instead of this left panel (which would sit under the studio panel).
  // The crystallography studio renders its own detail panel; its nodes are
  // painted manually and never enter entityCache, so this would be empty.
  if (graphName === 'cod_slice_v2' || graphName === 'cod_contacts_v2') return
