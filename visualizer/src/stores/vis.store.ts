...
export type VisStore = {
  ...
  setCrystalOpen: (v: boolean) => void
  renderedGraph: string
  setRenderedGraph: (v: string) => void
  ragFocus: { graph: string; ids: string[] } | null
  setRagFocus: (v: { graph: string; ids: string[] } | null) => void
...
export const useVisStore = create<VisStore>((set) => {
  ...
  return {
    ...
    isCrystalOpen: false,
    setCrystalOpen: (v: boolean) => set(() => ({ isCrystalOpen: v })),
    renderedGraph: '',
    setRenderedGraph: (v: string) => set(() => ({ renderedGraph: v })),
    ragFocus: null,
    setRagFocus: (v: { graph: string; ids: string[] } | null) => set(() => ({ ragFocus: v })),
